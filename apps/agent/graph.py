...
def _goal_tick_action_pack(
    ...
    system = "\n".join(
        [
            ...
            "- For `googlecalendar_update_event`, args MUST include: eventId (string), and at least one of startISO/endISO/summary as needed.",
            "- For `googlecalendar_delete_event`, args MUST include: eventId (string).",
            "- Do NOT emit googlecalendar_create_event unless you need a **new** event; if missing fields, ask in `message`.",
