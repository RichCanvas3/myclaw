...
export async function orchestratorPlan(params: {
  ...
  const system = [
    ...
    "",
    "Examples:",
    '- User: "send email to richard@example.com that says hi" -> actions: [{"type":"mcp.tool","input":{"server":"gym-sendgrid","tool":"sendEmail","args":{"to":"richard@example.com","subject":"Hi","text":"Hi"}}}]',
