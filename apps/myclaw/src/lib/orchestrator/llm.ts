...
export async function orchestratorPlan(params: {
  ...
  const system = [
    ...
    '- {"type":"mcp.tool","input":{"server":"gym-weather"|"gym-telegram"|"gym-weight","tool":"...","args":{...}}}',
    ...
    "- For meal photos: call weight_analyze_meal_photo first; after user confirms, use weight_log_food_from_analysis (items or aggregate).",
